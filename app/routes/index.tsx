            ...
            <div className="absolute inset-0">
              <img
                className="h-full w-full object-cover"
                  src="https://assets.goal.com/v3/assets/bltcc7a7ffd2fbf71f5/blt5f60f148aa4c0abd/63260bfd0c7ca54c537c9449/GettyImages-1424657540.jpg"
                alt="son is doing his signiture pose"
              />
              <div className="absolute inset-0 bg-[color:rgba(139,92,246,0.5)] mix-blend-multiply" />
            </div>
            <div className="lg:pb-18 relative px-4 pt-16 pb-8 sm:px-6 sm:pt-24 sm:pb-14 lg:px-8 lg:pt-32">
              <h1 className="text-center text-6xl font-extrabold tracking-tight sm:text-8xl lg:text-9xl">
                  <span className="block uppercase text-indigo-400 drop-shadow-md">
                  Nami's App
                </span>
              </h1>
              <p className="mx-auto mt-6 max-w-lg text-center text-xl text-white sm:max-w-3xl">
                login & leave a note for me❤
              </p>
              ...
              <a href="#">
                  {/*https://remix.run*/}
                <img
                  src="https://www.svgrepo.com/show/207543/cloud.svg"
                  alt="Remix"
